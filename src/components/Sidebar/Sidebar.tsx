...
export default function Sidebar({
    ...
    '
        >
            <div
                className='flex flex-col  w-64 min-h-screen bg-[#2c2c38]  border-r overflow-y-auto
      '
            >
                ...
                <div
                    className='app-sidebar-notes min-h-screen 
        '
                >
                    {sortedNotes?.map(
                        (
                            { id, title, body, lastModified }: any,
                            key: number
                        ) => (
                            <div
                                className={`sidebar-notes cursor-pointer p-4  hover:bg-black
                            ${
                                // @ts-ignore
