...
export default function Main({ activeNote, onUpdateNote }: MainProps) {
    ...
    if (!activeNote)
        return (
            <div
                className='no-active-note text-3xl text-gray-400 font-bold text-center mt-56 ml-96
  '
            >
                No note selected
            </div>
    ...
    return (
        <div className='app-main w-full h-full ml-10 mt-10'>
            <div className='app-main-note-edit'>
               ...
               text-3xl font-bold border-b-2 outline-none'
